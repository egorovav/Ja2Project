...
namespace dotNetStiEditor
{
	...
	public class World
	{
		...
		public void CreateViewport
			(object appObject,Graphics hdc,Point position, Rectangle area,Image background, bool drawTile)
		{
			WorldView myViewport=new WorldView();
			myViewport.SetViewport(appObject,hdc,position,area,background,Library);
			myViewport.DrawTile = drawTile;
		...
		#region Sprites
		public void AddSprite(Canvas canvas, bool useOffset)
		{
			Sprite sprite=new Sprite(canvas, useOffset);
			sprite.oZorder=Library.Count;
			Library.Add(sprite);
		}
		public void AddSprite(Canvas canvas,Point position, bool useOffset)
		{
			Sprite sprite=new Sprite(canvas, useOffset);
			sprite.oZorder=Library.Count;
		...
		public void AddSprite
			(Canvas canvas, Point position, int frames, int fps, bool animated, bool useOffset)
		{
			Sprite sprite=new Sprite(canvas, useOffset);
			sprite.oZorder=Library.Count;
			sprite.oPosition=position;
