...
namespace StiLib
{
    public class StciData
    {
        ...
        public StciData(string fileName, long offset)
        {
            using (BinaryReader stiHeaderReader = new BinaryReader(new FileStream(fileName, FileMode.Open, FileAccess.Read)))
            {
                this.fileName = fileName;
								stiHeaderReader.BaseStream.Seek(offset, SeekOrigin.Begin);
